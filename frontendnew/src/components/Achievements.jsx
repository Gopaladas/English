...
import AchievementsUpload from "./Admin/Achievements/Achievements";
...
const Achievements = () => {
  ...
  const handleUpload = () => {
    navigate("/achivements/uploadAchivement");
  };

  return (
    <div className="p-8 bg-gray-100 min-h-screen font-serif">
      <h1 className="text-3xl font-bold mb-6 text-center text-gray-800">
        Achievements of the English Department
      </h1>
      ...
      <div className="space-y-6">
        {achievements.map((achievement, index) => (
          <div key={index} className="p-6 bg-white rounded-lg shadow-md">
            ...
            <h2 className={`text-2xl font-semibold mb-2 ${achievement.color}`}>
              {achievement.title}
            </h2>
